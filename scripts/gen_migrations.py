...
MIGRATIONS["040_subscription_lifecycle.sql"] = HEADER.format(
    name="040_subscription_lifecycle",
    desc="Atomic subscription activation and expiration helpers.",
) + """
...
def main() -> None:
    ...
    assert len(MIGRATIONS) == 40, len(MIGRATIONS)
